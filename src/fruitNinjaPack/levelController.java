...
public void SliceObject(Event event) throws IOException {
	...
	String Slicesound = "bamboo-swipe-1.wav";
	Media slicesong = new Media(new File(Slicesound).toURI().toString());
	MediaPlayer mediaPlayerslice = new MediaPlayer(slicesong);
	
	
	String bombsound = "menu-bomb.wav";
	Media bombsong = new Media(new File(bombsound).toURI().toString());
	MediaPlayer mediaPlayerbomb = new MediaPlayer(bombsong);
	
	
	String lifesound = "extra-life.wav";
	Media lifesong = new Media(new File(lifesound).toURI().toString());
	MediaPlayer mediaPlayerlife = new MediaPlayer(lifesong);
   ...
   gold.setY(fruitImage1.getY());
	...
	slicedappleImageleft.setX(fruitImage1.getX());
	slicedappleImageright.setX(fruitImage1.getX());
	slicedbannanaImageright.setX(fruitImage1.getX());
	slicedbannanaImageleft.setX(fruitImage1.getX());
	slicedWatermelon.setX(fruitImage1.getX());
...
private void doTime() {
	...
	KeyFrame frame = new KeyFrame(Duration.seconds(1), new EventHandler<ActionEvent>() {
		...
		public void handle(ActionEvent event) {
			;
			seconds++;
			timelabel.setText(Integer.toString(seconds)+ " : " + Integer.toString(minutes) + " : " +Integer.toString(hours));
			if (seconds == 59) {
				minutes++;
				seconds = -1;
			}
